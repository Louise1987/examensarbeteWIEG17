...
using EpiserverSiteECommerce.Models;
using EpiserverSiteECommerce.Models.Pages;
using EPiServer.DataAnnotations;
using EPiServer.DataAbstraction;
using EPiServer.Core;
using EpiserverSiteECommerce.Models.Blocks;
...
namespace EpiserverSiteECommerce.Models.Pages
{
    ...
    [SiteContentType(
        ...
        GroupName = EpiserverSiteECommerce.Global.GroupNames.Specialized,
